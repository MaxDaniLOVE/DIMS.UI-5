...
const defaultMembersTaskHeaders = [
  { value: '#', id: 'index', isSortable: false },
...
const membersTasksHeaders = {
  USER: [...defaultMembersTaskHeaders, { value: 'Manage', id: 'manage', isSortable: false }],
  ADMIN: [...defaultMembersTaskHeaders, { value: 'Mark', id: 'manage', isSortable: false }],
  MENTOR: [...defaultMembersTaskHeaders, { value: 'Mark', id: 'manage', isSortable: false }],
};
